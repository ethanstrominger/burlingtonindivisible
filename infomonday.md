...
- We do not antagonize or in any way engage with counter pro-ICE protestors.  Do not use the median near the cross walk.  They get energy from engaging with us and can use these interactions to attract followers.
...
- We protest systems, not people. Our goal is moral clarity without hostility. Please keep chants firm, clear, and grounded in human dignity.  If an ICE vehicle passes, consider
phrases like "No cages, no cruelty", "You can quit","Do the right thing, quit", "Stop the cruelty/destroying families/breaking the law", or "Show compassion".

# Tips for handling counterprotesters
Counter protestors often try to engage with you starting
with an innocent sounding question, and then trap you in a situation where you get frustrated or confused.  They use interactions for material to attract views, so it is best not to engage.  Here are some strategies
...
- Security patrols look for people exiting cars with signs or walking directly to the protest. If you buy something at a store, you may be entitled to park there, but this is not guaranteed. National Development Corp manages the lots.
...
- The strip mall at the end of District Ave (with Just Salad) or the Kohl's lot are also options. Neither have security patrols and no towing has occurred from there. Walk into a business to make it difficult to be identified as a protestor.
- On Mon, Tue, and Sat, protests start at Burlington Mall Road. You can see if towing starts at the strip mall and move your car if needed.
